...
\teammitglied{KAUFMANN}{Sophie}
\teammitglied{RAICHLE}{Marcel}
\teammitglied{RIEDL}{Patrick}

% Supervisors -- the optional argument is the label on the title page.
\betreuung[Betreuer]{Titel Thomas SPACHINGER, Titel}
\betreuung[Betreuer]{Titel Thomas ANGERMAYER, Titel}
